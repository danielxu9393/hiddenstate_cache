...
class MPTModel(MPTPreTrainedModel):
    ...
    def forward(
        ...
        use_hscache: Optional[bool] = None,  ###
        ...
        if self.learned_pos_emb:
            ...
            if use_hscache and hidden_state_cache is not None:  ###
                past_position = hidden_state_cache.get_past_length()
        ...
        for b_idx, block in enumerate(self.blocks):
            ...
            #     past_hidden_state = None
            # elif use_hscache and hidden_state_cache.kv_transform is not None:
            #     ### janky way to reroute logic to approximator...
            #     past_key_value = hidden_state_cache.get_kv(b_idx)
            #     past_hidden_state = None
            # else:
            #     past_hidden_state = hidden_state_cache.get_layer(b_idx)
            ...
            # print(f"layer {b_idx}: ", x)
            # print(f"Block {b_idx} time: {time.time() - block_time}")
